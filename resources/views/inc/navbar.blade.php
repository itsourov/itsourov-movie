<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-800 border-b dark:border-gray-700  ">
                    ...
                    <button type="button"
                        ...
                        @auth
                            <img class="w-8 h-8 rounded-full border  border-primary-400"
                                ...
                                alt="">
                        @else
                            <img class="w-8 h-8 rounded-full border  border-primary-400" src="{{ asset('/img/user.png') }}"
                                alt="">
                        @endauth
