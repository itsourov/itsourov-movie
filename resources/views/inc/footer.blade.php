<section class="py-10 mt-10 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 sm:pt-16 lg:pt-24">
    <div class="px-2 mx-auto  container">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="{{ asset('img/logo.png') }}" alt="" />

                <p class="text-base leading-relaxed text-gray-500 mt-7">Amet minim mollit non deserunt ullamco est sit
            ...
            <div>
                <p class="text-sm font-semibold tracking-widest uppercase">Company</p>
            ...
            <div>
                <p class="text-sm font-semibold tracking-widest uppercase">Help</p>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest uppercase">Subscribe to newsletter</p>
        ...
        <p class="text-sm text-center text-gray-500">© Copyright 2021, All Rights Reserved by Postcraft</p>
    </div>
</section>
